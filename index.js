...
client.on('message-new', async (m) => {
   ...
   switch (prefix) {
       case 'help':
           ...
           break      
      case 'donate':
           client.sendMessage(id, donate.donate(id, A187, tanggal),MessageType.text, { quoted: m } )
           break          
      case 'info':
           client.sendMessage(id, info.info(id, A187, tanggal),MessageType.text, { quoted: m } )
           break             
       case 'nulis':
           nulis(value)
               .then(data => {
